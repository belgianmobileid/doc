	...
	<tbody>
		<tr>
			...
			<td>
				...
				<br/>
				<img
					src="{{ '/assets/deeplink/deeplink-common-samsung-internet-browser.png' | relative_url }}"
		...
		<tr>
			...
			<td>
				...
				<div style="display: flex; gap: 8px; flex-wrap: wrap;">
					<img src="{{ '/assets/deeplink/deeplink-common-firefox1.png' | relative_url }}" alt="Firefox setting screen 1" style="max-width: 120px; border-radius: 6px;">
					<img src="{{ '/assets/deeplink/deeplink-common-firefox2.png' | relative_url }}" alt="Firefox setting screen 2" style="max-width: 120px; border-radius: 6px;">
					<img src="{{ '/assets/deeplink/deeplink-common-firefox3.png' | relative_url }}" alt="Firefox setting screen 3" style="max-width: 120px; border-radius: 6px;">
				</div>
			</td>
		</tr>
        ...
        The only solution is to clear the Safari app cache and try again.
				<br/>
				<img src="{{ '/assets/deeplink/deeplink-common-safari.jpeg' | relative_url }}" alt="Safari prompt for opening app" style="max-width: 120px; border-radius: 6px;">
			</td>
		</tr>
