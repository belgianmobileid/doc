...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">account_token</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <span class="paramReq" >REQUIRED</span>
      ...
      <td>
        ...
        <table>
          <tbody>
            <tr>
              <td><div class="paramName" style="padding-left: calc(0*20px);">typ</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <span class="paramReq" >REQUIRED</span>
            ...
            <tr>
              <td><div class="paramName" style="padding-left: calc(0*20px);">alg</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <span class="paramReq" >OPTIONAL</span>
            ...
            <tr>
              <td><div class="paramName" style="padding-left: calc(0*20px);">azp</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">clientData</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">redirect_url</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<table>
  <tbody>
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">maxResults</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<table>
  <tbody>
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">credentialID</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">certificates</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">certInfo</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">authInfo</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">numSignatures</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">hash</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">description</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">SAD</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">signAlgo</div>
<div class="param2" style="padding-left: calc(0*20px);">
