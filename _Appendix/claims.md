---
layout: bigtable
compact_claims_availability: true
...
<table id="claims-availability">
  <tbody>
    ...
    <tr>
      ...
      <td>MAY NOT</td> <!-- Croatia -->
      <td>MAY NOT</td> <!-- Lithuania -->
      <td>MAY NOT</td> <!-- Slovenia -->
    ...
    <tr>
      ...
      <td>Only if "email" available</td> <!-- Croatia -->
      <td>Only if "email" available</td> <!-- Lithuania -->
      <td>Only if "email" available</td> <!-- Slovenia -->
    ...
    <tr>
      <td><b>address_assurance_level</b></td>
      <td>Indicates the level of assurance associated with the user's address claim, depending on whether the address is <code>SELF_DECLARED</code> (provided by the user without verification), <code>VALIDATED</code> (provided by the user and validated against a source), or <code>VERIFIED</code> (obtained from an official document).</td>
      <td>SHALL</td> <!-- Belgium -->
      <td>MAY NOT</td> <!-- Netherlands -->
      <td>SHALL NOT</td> <!-- Luxembourg -->
      <td>SHALL NOT</td> <!-- Ireland -->
    ...
    <tr>
      ...
      <td>User's Croatian unique identification number.</td>
      <td>SHALL NOT</td> <!-- Belgium -->
      <td>SHALL NOT</td> <!-- Netherlands -->
      <td>SHALL NOT</td> <!-- Luxembourg -->
      <td>SHALL NOT</td> <!-- Ireland -->
    ...
    <tr>
      ...
      <td>User's Lithuanian unique identification number.</td>
      <td>SHALL NOT</td> <!-- Belgium -->
      <td>SHALL NOT</td> <!-- Netherlands -->
      <td>SHALL NOT</td> <!-- Luxembourg -->
      <td>SHALL NOT</td> <!-- Ireland -->
    ...
    <tr>
      ...
      <td>User's Slovenian unique identification number.</td>
      <td>SHALL NOT</td> <!-- Belgium -->
      <td>SHALL NOT</td> <!-- Netherlands -->
      <td>SHALL NOT</td> <!-- Luxembourg -->
      <td>SHALL NOT</td> <!-- Ireland -->
    ...
    <tr>
      ...
      <td>User's Latvian unique identification number.</td>
      <td>SHALL NOT</td> <!-- Belgium -->
      <td>SHALL NOT</td> <!-- Netherlands -->
      <td>SHALL NOT</td> <!-- Luxembourg -->
      <td>SHALL NOT</td> <!-- Ireland -->
    ...
    <tr>
      ...
      <td>User's Serbian unique identification number.</td>
      <td>SHALL NOT</td> <!-- Belgium -->
      <td>SHALL NOT</td> <!-- Netherlands -->
      <td>SHALL NOT</td> <!-- Luxembourg -->
      <td>SHALL NOT</td> <!-- Ireland -->
    ...
    <tr>
      ...
      <td>User's Moldovan unique identification number.</td>
      <td>SHALL NOT</td> <!-- Belgium -->
      <td>SHALL NOT</td> <!-- Netherlands -->
      <td>SHALL NOT</td> <!-- Luxembourg -->
      <td>SHALL NOT</td> <!-- Ireland -->
