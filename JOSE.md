...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">kid</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <span class="paramReq" >Required</span>
        ...
        <tr>
        <td><div class="paramName" style="padding-left: calc(0*20px);">enc</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <span class="paramReq" >Required</span>
        ...
        <tr>
        <td><div class="paramName" style="padding-left: calc(0*20px);">cty</div>
<div class="param2" style="padding-left: calc(0*20px);">
