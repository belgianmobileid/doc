...
<table>
  <tbody>
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">partnerCode</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">userCode</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">serviceCode</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">lang</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">redirectUrl</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <span class="paramReq" >ALWAYS</span>
</div></td>
      <td>It is the status of User Identification Request.</td>
    </tr>
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">statusReason</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">asyncRespID</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">identificationUrl</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">certificate</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">fullCertificateChain</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<table>
  <tbody>
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">inDocs</div>
<div class="param2" style="padding-left: calc(0*20px);">
    
        <span class="paramType">object</span>  
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(1*20px);">docHash</div>
<div class="param2" style="padding-left: calc(1*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(2*20px);">id</div>
<div class="param2" style="padding-left: calc(2*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(2*20px);">di</div>
<div class="param2" style="padding-left: calc(2*20px);">
    
        <span class="paramType">array of objects</span>  
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(3*20px);">alg</div>
<div class="param2" style="padding-left: calc(3*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(3*20px);">value</div>
<div class="param2" style="padding-left: calc(3*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">reqID</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">optInp</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(1*20px);">lang</div>
<div class="param2" style="padding-left: calc(1*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(1*20px);">itsme</div>
<div class="param2" style="padding-left: calc(1*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(2*20px);">signer</div>
<div class="param2" style="padding-left: calc(2*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(3*20px);">userCode</div>
<div class="param2" style="padding-left: calc(3*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(2*20px);">partnerCode</div>
<div class="param2" style="padding-left: calc(2*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(2*20px);">serviceCode</div>
<div class="param2" style="padding-left: calc(2*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(2*20px);">description</div>
<div class="param2" style="padding-left: calc(2*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(3*20px);">lang</div>
<div class="param2" style="padding-left: calc(3*20px);">
...
<div class="param2" style="padding-left: calc(3*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(2*20px);">redirectUrl</div>
<div class="param2" style="padding-left: calc(2*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(2*20px);">signPolicy</div>
<div class="param2" style="padding-left: calc(2*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(3*20px);">signPolicyRef</div>
<div class="param2" style="padding-left: calc(3*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(3*20px);">commitmentTypeRef</div>
<div class="param2" style="padding-left: calc(3*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(3*20px);">signerRole</div>
<div class="param2" style="padding-left: calc(3*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(4*20px);">lang</div>
<div class="param2" style="padding-left: calc(4*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(4*20px);">value</div>
<div class="param2" style="padding-left: calc(4*20px);">
...
<table>
  <tbody>
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">result</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(1*20px);">maj</div>
<div class="param2" style="padding-left: calc(1*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(1*20px);">msg</div>
<div class="param2" style="padding-left: calc(1*20px);">
...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">respID</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">optOutp</div>
<div class="param2" style="padding-left: calc(0*20px);">
...
<div class="param2" style="padding-left: calc(1*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(2*20px);">signingUrl</div>
<div class="param2" style="padding-left: calc(2*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(2*20px);">userCode</div>
<div class="param2" style="padding-left: calc(2*20px);">
...
<div class="param2" style="padding-left: calc(1*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(1*20px);">min</div>
<div class="param2" style="padding-left: calc(1*20px);">
...
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">sigObj</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(1*20px);">b64Sig</div>
<div class="param2" style="padding-left: calc(1*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(2*20px);">value</div>
<div class="param2" style="padding-left: calc(2*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(1*20px);">whichdoc</div>
<div class="param2" style="padding-left: calc(1*20px);">
...
<table>
  <tbody>
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">400</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">409</div>
<div class="param2" style="padding-left: calc(0*20px);">
    ...
    <tr>
      <td><div class="paramName" style="padding-left: calc(0*20px);">500</div>
<div class="param2" style="padding-left: calc(0*20px);">
